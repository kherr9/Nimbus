            ...
            where TBusResponse : IBusMulticastResponse
        {
            ...
            using (var scope = _dependencyResolver.CreateChildScope())
            {
                ...
                foreach (var globalInterceptor in globalInterceptors)
                {
                    ...
                    await globalInterceptor.OnMulticastRequestHandlerExecuting(busRequest, message);
                ...
                if (exception == null)
                {
                    ...
                    foreach (var globalInterceptor in globalInterceptors.Reverse())
                    {
                        ...
                        await globalInterceptor.OnMulticastRequestHandlerSuccess(busRequest, message);
                ...
                else
                {
                    ...
                    foreach (var globalInterceptor in globalInterceptors.Reverse())
                    {
                        ...
                        await globalInterceptor.OnMulticastRequestHandlerError(busRequest, message, exception);
